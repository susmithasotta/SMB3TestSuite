...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Sspi
{
    ...
    /// </summary>
    public struct SecurityPackageInfomation
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor. Convert SspiSecurityPackageInfomation to SecurityPackageInfomation.
        /// </summary>
        /// <param name="securityPackageInfo">Security package info</param>
        internal SecurityPackageInfomation(SspiSecurityPackageInfomation securityPackageInfo)
        {
