...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Sspi
{
    ...
    public struct SecurityPackageContextNegotiationInfo
    {
        ...
        /// </summary>
        public SecurityPackageInfomation PackageInfo;
        ...
        {
            SspiSecurityPackageInfomation sspiNegotiationInfo;

            sspiNegotiationInfo = (SspiSecurityPackageInfomation)Marshal.PtrToStructure(
                negotiationInfo.PackageInfo, 
                typeof(SspiSecurityPackageInfomation));
            this.PackageInfo = new SecurityPackageInfomation(sspiNegotiationInfo);
