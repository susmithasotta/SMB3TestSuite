...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Sspi
{
    ...
    public class SspiServerSecurityContext : ServerSecurityContext, IDisposable
    {
        ...
        {
            SecurityBuffer tokenBuffer = new SecurityBuffer(SecurityBufferType.Token, clientToken);
            SecurityBufferDescWrapper inputBufferDescWrapper = new SecurityBufferDescWrapper(tokenBuffer);
