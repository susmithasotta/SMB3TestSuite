...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Sspi
{
    ...
    public class SspiClientSecurityContext : ClientSecurityContext, IDisposable
    {
        ...
        /// Credential handle.
        /// </summary>
        private SecurityHandle credentialHandle;

        /// <summary>
        /// Context handle.
        /// </summary>
        private SecurityHandle contextHandle;
        ...
        {
            SspiUtility.Encrypt(ref this.contextHandle, this.sequenceNumber, securityBuffers);
        }
        ...
        {
            uint hResult;
            SecurityBuffer tokenBuffer = new SecurityBuffer(SecurityBufferType.Token, serverToken);
            SecurityBuffer outTokenBuffer = new SecurityBuffer(
                SecurityBufferType.Token, 
                new byte[NativeMethods.MAX_TOKEN_SIZE]);
            SecurityBufferDescWrapper serverTokenDescWrapper = new SecurityBufferDescWrapper(tokenBuffer);
