...
//
// Description: This file is the context of client of NLMP.
//------------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Nlmp
{
    ...
    public class NlmpClientContext : NlmpContext
    {
        ...
        /// client.
        /// </summary>
        private NegotiateTypes clientConfigFlags;
        ...
        public NegotiateTypes ClientConfigFlags
        {
            get
            {
                return this.clientConfigFlags;
            }
            set
            {
                this.clientConfigFlags = value;
            }
        }
