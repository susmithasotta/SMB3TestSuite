...
//
// Description: This file is the client of NLMP, send message to server.
//------------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Nlmp
{
    ...
    public class NlmpClient
    {
        ...
        /// </summary>
        /// <param name="negotiateFlags">this flags indicates the capabilites that client supoorts.</param>
        /// <param name="version">
        ...
        /// </param>
        /// <param name="userName">
        /// The name of the user to be authenticated. UserName MUST be encoded in thenegotiated character set.This 
