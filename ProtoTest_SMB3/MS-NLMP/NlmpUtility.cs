...
//
// Description: This file is the utility of nlmp, all security algorithms.
//------------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Nlmp
{
    ...
    public static class NlmpUtility
    {
        ...
        /// </summary>
        internal const int NLMP_SECURITY_PACKAGE_CONTEXT_SIZES = 16;
        ...
        /// <summary>
        /// the map between a hanle and a key.
        ...
        /// nonsignificant ones. The result is a string.
        /// </summary>
        ...
        /// <exception cref="ArgumentException">the size can not be nagative</exception>
            ...
            )
        {
            if (size < 0)
            {
                throw new ArgumentOutOfRangeException("size", size, "size can not be nagative");
            }
            ...
            )
        {
            if (size < 0)
            {
                throw new ArgumentException("size can not be nagative", "size");
            }
        ...
        /// <param name="userName">the name of user</param>
        /// <param name="password">the password of user</param>
        /// <returns>the version 2 of LM resonse key</returns>
        ...
        /// <summary>
        /// If set, requests LAN Manager(LM) session key compucation.
        /// </summary>
        /// <param name="negotiateFlags">the negotiateFlags of NegotiateFlags</param>
        ...
        /// <param name="negotiateFlags">the negotiate negotiateFlags, indicates the capabilites of server/client</param>
        /// <param name="handle">
        /// the handle of encypt key, this value can be ClientHandle/ServerHandle in Context.
        /// </param>
