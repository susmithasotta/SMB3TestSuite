...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class KDCOptions : KerberosFlags {
      ...
      public KDCOptions (int numbits_, byte[] data) :
         base (numbits_, data)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KDCOptions (bool[] bitValues) :
         base (bitValues)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KDCOptions (string value_) :
         base (value_)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KDCOptions (System.Collections.BitArray bitArray) :
         base (bitArray)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
