...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class AP_REP : Asn1Type {
      public new readonly static Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 15);
