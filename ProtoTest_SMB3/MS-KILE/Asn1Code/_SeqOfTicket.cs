...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class _SeqOfTicket : Asn1Type {
      public Ticket[] elements;

      public _SeqOfTicket () : base()
      {
         elements = null;
      ...
      /// populated.
      /// </summary>
      public _SeqOfTicket (int numRecords) : base()
      {
         elements = new Ticket [numRecords];
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfTicket (Ticket[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Ticket [llist.Count];
