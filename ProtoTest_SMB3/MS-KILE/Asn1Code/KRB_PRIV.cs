...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class KRB_PRIV : Asn1Type {
      public new readonly static Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 21);

      public Asn1Integer pvno;
      public Asn1Integer msg_type;
      public EncryptedData enc_part;

      public KRB_PRIV () : base()
      {
         Init();
