...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class ETYPE_INFO : Asn1Type {
      public ETYPE_INFO_ENTRY[] elements;

      public ETYPE_INFO () : base()
      {
         elements = null;
      ...
      /// populated.
      /// </summary>
      public ETYPE_INFO (int numRecords) : base()
      {
         elements = new ETYPE_INFO_ENTRY [numRecords];
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      /// given the array.  
      /// </summary>
      public ETYPE_INFO (ETYPE_INFO_ENTRY[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         ETYPE_INFO_ENTRY element;
         int elemLen = 0;

         while (!_context.Expired()) {
            element = new ETYPE_INFO_ENTRY();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new ETYPE_INFO_ENTRY [llist.Count];
