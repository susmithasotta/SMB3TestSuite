...
// (http://www.obj-sys.com).  Version: 6.07, Date: 24-Aug-2009.
// 
using System;
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class PA_DATAS : Asn1Type {
      public PA_DATA[] elements;

      public PA_DATAS () : base()
      {
         elements = null;
      ...
      /// populated.
      /// </summary>
      public PA_DATAS (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PA_DATAS (PA_DATA[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
