...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class HostAddresses : Asn1Type {
      public HostAddress[] elements;

      public HostAddresses () : base()
      {
         elements = null;
      ...
      /// populated.
      /// </summary>
      public HostAddresses (int numRecords) : base()
      {
         elements = new HostAddress [numRecords];
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      /// given the array.  
      /// </summary>
      public HostAddresses (HostAddress[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         while (!_context.Expired()) {
            element = new HostAddress();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new HostAddress [llist.Count];
