...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class AuthorizationData : Asn1Type {
      public AuthorizationData_element[] elements;

      public AuthorizationData () : base()
      {
         elements = null;
      ...
      /// populated.
      /// </summary>
      public AuthorizationData (int numRecords) : base()
      {
         elements = new AuthorizationData_element [numRecords];
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      /// given the array.  
      /// </summary>
      public AuthorizationData (AuthorizationData_element[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         AuthorizationData_element element;
         int elemLen = 0;

         while (!_context.Expired()) {
            element = new AuthorizationData_element();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new AuthorizationData_element [llist.Count];
