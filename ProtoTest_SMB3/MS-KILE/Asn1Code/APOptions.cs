...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class APOptions : KerberosFlags {
      ...
      public APOptions (int numbits_, byte[] data) :
         base (numbits_, data)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public APOptions (bool[] bitValues) :
         base (bitValues)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public APOptions (string value_) :
         base (value_)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public APOptions (System.Collections.BitArray bitArray) :
         base (bitArray)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
