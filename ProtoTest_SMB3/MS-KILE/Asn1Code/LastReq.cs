...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class LastReq : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public LastReq (int numRecords) : base()
      {
         elements = new LastReq_element [numRecords];
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      /// given the array.  
      /// </summary>
      public LastReq (LastReq_element[] elements_) : base()
      {
         elements = elements_;
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         LastReq_element element;
         int elemLen = 0;

         while (!_context.Expired()) {
            element = new LastReq_element();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new LastReq_element [llist.Count];
