...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class AP_REQ : Asn1Type {
      public new readonly static Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 14);
      ...
      public AP_REQ (
         ...
         APOptions ap_options_,
         Ticket ticket_,
         EncryptedData authenticator_
      )
         : base ()
      {
         pvno = pvno_;
         msg_type = msg_type_;
         ap_options = ap_options_;
         ticket = ticket_;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         if (_context.MatchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 2, elemLen, true)) {
            ...
            ap_options.Decode (buffer, true, elemLen.mValue);
            if (elemLen.mValue == Asn1Status.INDEFLEN) {
               MatchTag (buffer, Asn1Tag.EOC);
            }
         }
         ...
         if (_context.MatchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 4, elemLen, true)) {
            authenticator = new EncryptedData();
            authenticator.Decode (buffer, true, elemLen.mValue);
            if (elemLen.mValue == Asn1Status.INDEFLEN) {
               MatchTag (buffer, Asn1Tag.EOC);
            }
         }
      ...
      public override int Encode (Asn1BerEncodeBuffer buffer, bool explicitTagging)
      {
         ...
         len = authenticator.Encode (buffer, true);
         ...
         len = ap_options.Encode (buffer, true);
