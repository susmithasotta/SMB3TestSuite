...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile {
   ...
   public class KerberosFlags : Asn1BitString {
      ...
      public KerberosFlags (int numbits_, byte[] data) :
         base (numbits_, data)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KerberosFlags (bool[] bitValues) :
         base (bitValues)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KerberosFlags (string value_) :
         base (value_)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
      ...
      public KerberosFlags (System.Collections.BitArray bitArray) :
         base (bitArray)
      {
         SetKey (_KerberosV5Spec2Values._rtkey);
      }
