...
//
// Description: This file implements const values used in this project
//              
//
//              
//------------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile
{
    ...
    internal class ConstValue
    {
        ...
        /// </summary>
        internal const int RC4_KEY_LENGTH = 16;
        ...
        /// </summary>
        internal const byte MAX_SIGNATURE_SIZE = 255;
        ...
        /// </summary>
        internal const int RC4_BLOCK_SIZE = 1;
        ...
        /// </summary>
        internal const int CRC32_CHECKSUM_SIZE = 4;

        /// <summary>
        /// (16 bytes) MD5 Checksum Size
        /// </summary>
        internal const int MD5_CHECKSUM_SIZE = 16;

        /// <summary>
        /// (12 bytes) HMAC Hash Output Size
        /// [RFC 3962, Section 6]
        /// </summary>
        internal const int HMAC_HASH_OUTPUT_SIZE = 12;
