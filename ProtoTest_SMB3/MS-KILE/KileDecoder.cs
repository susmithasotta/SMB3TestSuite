...
// All rights reserved.
//
// Module Name: KILE Decoder Class
//
// Abstract:
// Provide decoding call back for MS-KILE Stack SDK
//
// Build Date: 01/06/2010(21:22PM)
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile
{
    ...
    internal class KileDecoder
    {
        ...
        /// </summary>
        private KileClientContext clientContext;

        /// <summary>
        /// Kile Server Context
        /// (which maintains certain state variables for kile server currently operated context)
        /// </summary>
        private KileServerContext serverContext;

        /// <summary>
        /// Kile Server Context List
        /// </summary>
        private Dictionary<KileConnection, KileServerContext> serverContextList;
        ...
        /// <exception cref="System.FormatException">thown when a kile message type is unsupported</exception>
