...
// All rights reserved.
//
// Module Name: Rc4HmacCrypto Class
//
// Abstract:
// Provide encryption/decryption methods for rc4-hmac and rc4-hmac-exp
//
// Reference:
// RFC 4757 - The RC4-HMAC Kerberos Encryption Types Used by Microsoft Windows
// 
// Build Date: 01/08/2010(19:05PM)
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile
{
    ...
    public static class Rc4HmacCrypto
    {
        ...
        private static byte[] GetSalt(KeyUsageNumber usage, EncryptionType encryptionType)
        {
            ...
            EncryptionType encryptionType)
        {
            ...
            // get checksum
            byte[] checksum = CryptoUtility.ComputeMd5Hmac(hash, plainData);
            ...
            EncryptionType encryptionType)
        {
            ...
            // verify checksum
            byte[] expectedChecksum = CryptoUtility.ComputeMd5Hmac(hash, plain);
