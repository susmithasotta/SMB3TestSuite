...
// All rights reserved.
//
// Module Name: DesCbcCrypto Class
//
// Abstract:
// Provide encryption/decryption methods for des-cbc-crc32 and des-cbc-md5
//
// Reference:
// RFC 3961 - "Encryption and Checksum Specifications for Kerberos 5"
// RFC 1964 - "The Kerberos Version 5 GSS-API Mechanism"
// 
// Build Date: 01/08/2010(12:55PM)
...
namespace Microsoft.Protocols.TestTools.StackSdk.Security.Kile
{
    ...
    public static class DesCbcCrypto
    {
            ...
            EncryptionType encryptionType)
        {
            ...
            byte[] checksum = CalculateChecksum(paddedData, encryptionType);
            ...
            EncryptionType encryptionType)
        {
            ...
            // verify checksum
            byte[] expectedChecksum = CalculateChecksum(decryptedData, encryptionType);
