...
This project calls ASN1C compiler to generate the C# code ASN.1 definition.
...
employee.asn
   It contains the ASN.1 definition. 
   Project build will call the ASN1C compiler to produce the C# code for this
   definition. The ASN1C compiler will produce the PersonnelRecord.cs,
   Name.cs, EmployeeNumber.cs, Date.cs, ChildInforamation.cs,
   _EmployeeValues.cs, _SeqOfChildInformation.cs files.
   Look up project property to change the ASN1C option.
