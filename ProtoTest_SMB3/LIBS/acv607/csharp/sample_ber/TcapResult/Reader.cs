	...
	public class Reader
	{
		...
		public static void  Main(System.String[] args)
		{
			...
			try
			{
				...
				if (trace)
				{
					System.Console.Out.WriteLine("Decode MessageType was successful");
				...
				Undirectional undirectional = (Undirectional) messageType.GetElement();
				
				ReturnResult resultPDU = (ReturnResult) undirectional.components.elements[0].GetElement();
				
				Asn1BerDecodeBuffer decodeBuffer2 = 
               new Asn1BerDecodeBuffer(resultPDU.result.parameter.mValue);
				...
				if (trace)
				{
					System.Console.Out.WriteLine("Decode CallInfoFromResource_RESULT was successful");
					result.Print("result");
				}
			}
