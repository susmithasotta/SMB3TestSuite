	...
	public class Reader
	{
		...
		public static void  Main(System.String[] args)
		{
			...
			try
			{
				...
				Invoke invoke = (Invoke) undirectional.components.elements[0].GetElement();
				
				Asn1BerDecodeBuffer decodeBuffer2 = 
               new Asn1BerDecodeBuffer(invoke.parameter.mValue);
               ...
               new CallInfoFromResource_ARGUMENT();
				...
				if (trace)
				{
					System.Console.Out.WriteLine("Decode CallInfoFromResource_ARGUMENT was successful");
					param.Print("param");
				}
			}
