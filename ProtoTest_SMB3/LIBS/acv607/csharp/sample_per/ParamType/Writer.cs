...
namespace Sample_per.ParamType
{
	...
	public class Writer
	{
		...
		public static void  Main(System.String[] args)
		{
			...
			int[] algorithmOIDValue = new int[]{0, 0, 8, 2250, 0, 1};
			
			byte[] signatureValue = new byte[]{(byte) (0xaa), (byte) (0xbb),
			...
			signedName.signature = new Asn1BitString(signatureValue.Length * 8, signatureValue);
