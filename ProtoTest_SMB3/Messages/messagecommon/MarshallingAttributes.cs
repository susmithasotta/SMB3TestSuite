...
namespace Microsoft.Protocols.TestTools.StackSdk.Messages.Marshaling
{
    ...
    /// <summary>
    /// An attribute which associates an identifier binding (type <see cref="IdentifierBinding"/>)
    ...
    public sealed class IdentifierBindingAttribute : Attribute
    {
        ...
        /// same name in a given attribute context share the same <see cref="IdentifierBinding"/> 
