...
namespace Microsoft.Protocols.TestTools.StackSdk.Messages.Marshaling
{
    ...
    public struct MarshalingDescriptor
    {
        ...
        public static bool TryGetAttribute<T>(ICustomAttributeProvider provider, Type expectedType,
                                              string fieldName, out T fieldValue)
        {
    ...
    public class NativeMarshalingConfiguration : MarshalingConfiguration
    {
        ...
        protected NativeMarshalingConfiguration()
        {
            ...
            if (MessageRuntimeHelper.TryGetModelingSequence(typeof(int), out genericSequence))
            {
                RegisterGenericMarshaler(genericSequence.GetGenericTypeDefinition(),
                                            new GenericSequenceMarshaler());
                RegisterGenericMarshalerInline(genericSequence.GetGenericTypeDefinition(),
                                            new GenericSequenceMarshalerInline());
            }
    ...
    internal class StringUTF16MarshalerInline : ITypeMarshaler
    {
        ...
        public void Marshal(Marshaler marshaler, MarshalingDescriptor desc, object value)
        {
            ...
            if (MarshalerHelper.IsBigEndian(desc))
            {
                bs = Encoding.BigEndianUnicode.GetBytes(s);
            }
            else
            {
                bs = Encoding.Unicode.GetBytes(s);
            }
            for (int i = 0; i < bs.Length; i++)
                marshaler.WriteByte(bs[i]);
            if (bs.Length % 2 == 1)
    ...
    internal class GuidMarshaler : ITypeMarshaler
    {
        ...
        public int GetAlignment(Marshaler marshaler, MarshalingDescriptor desc)
        {
            return 1; // FIXME: alignment for Guid type?
        }
    ...
    internal class Asn1BerMarshaler : ITypeMarshaler
    {
        public int GetSize(Marshaler marshaler, MarshalingDescriptor descriptor, object value)
        {
            ...
            Asn1Type asnValue = value as Asn1Type;
            if (asnValue == null)
            {
                throw new ArgumentException("The type of Asn.1 value must be derived from 'Asn1Type'");
            }

            Asn1BerEncodeBuffer encodeBuffer = CreateEncodeBuffer();
            asnValue.Encode(encodeBuffer, true);

            return encodeBuffer.MsgLength;
        }
        ...
        public void Marshal(Marshaler marshaler, MarshalingDescriptor descriptor, object value)
        {
            ...
            foreach (byte b in encodeBuffer.MsgCopy)
            {
                marshaler.WriteByte(b);
            }
        }
        ...
        public object Unmarshal(Marshaler marshaler, MarshalingDescriptor descriptor)
        {
            ...
            Asn1Type value = (Asn1Type)Activator.CreateInstance(descriptor.Type);
            Asn1BufferedStream stream = new Asn1BufferedStream(marshaler);
            Asn1BerDecodeBuffer decodeBuffer = CreateDecodeBuffer(stream);
            value.Decode(decodeBuffer);

            return value;
        }

        protected virtual Asn1BerEncodeBuffer CreateEncodeBuffer()
        {
            return new Asn1BerEncodeBuffer();
        }

        protected virtual Asn1BerDecodeBuffer CreateDecodeBuffer(Stream stream)
        {
            if (stream == null)
            {
            ...
            return new Asn1BerDecodeBuffer(stream);
        }
    }
    #endregion
    ...
    {
        protected override Asn1BerEncodeBuffer CreateEncodeBuffer()
        {
            return new Asn1DerEncodeBuffer();
        }

        protected override Asn1BerDecodeBuffer CreateDecodeBuffer(Stream stream)
        {
            if (stream == null)
            {
                throw new ArgumentNullException("stream");
            ...
            return new Asn1DerDecodeBuffer(stream);
        }
    }
    #endregion
    ...
    internal class Asn1PerMarshaler : ITypeMarshaler
    {
        public int GetSize(Marshaler marshaler, MarshalingDescriptor descriptor, object value)
        {
            ...
            Asn1PerEncodeBuffer encodeBuffer = new Asn1PerEncodeBuffer(true);
            asnValue.Encode(encodeBuffer);
        ...
        public void Marshal(Marshaler marshaler, MarshalingDescriptor descriptor, object value)
        {
            ...
            Asn1PerEncodeBuffer encodeBuffer = new Asn1PerEncodeBuffer(IsAligned(descriptor));
            asnValue.Encode(encodeBuffer);
        ...
        public object Unmarshal(Marshaler marshaler, MarshalingDescriptor descriptor)
        {
            Asn1Type value = (Asn1Type)Activator.CreateInstance(descriptor.Type);
            Asn1BufferedStream stream = new Asn1BufferedStream(marshaler);
            Asn1PerDecodeBuffer decodeBuffer = new Asn1PerDecodeBuffer(stream, IsAligned(descriptor));
            value.Decode(decodeBuffer);
