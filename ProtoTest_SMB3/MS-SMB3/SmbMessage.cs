...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService.smb3
{
    ...
    public struct SmbNegotiateRequest
    {
        ...
        ///  smb3 will also send the smb3 dialect string, in addition
        ///  to the dialect string sent by  and later as described
        ///  above. If the smb3 dialect is negotiated, the Server
        ///  Message Block (SMB) Version 2.0 Protocol, as specified
        ///  in  [MS-smb3], is used instead of [CIFS] with these
        ///  extensions.
        /// </summary>
        [Size("ByteCount")]
