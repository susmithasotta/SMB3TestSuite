...
{
    /// <summary>
    /// A stucture contains information about lease
    /// </summary>
    public class smb3Lease
    {
        ...
        internal Dictionary<FILEID, smb3ServerOpen> leaseOpens;
        ...
        /// </summary>
        public ReadOnlyDictionary<FILEID, smb3ServerOpen> LeaseOpens
        {
            get
            {
                if (leaseOpens == null)
                ...
                {
                    return new ReadOnlyDictionary<FILEID, smb3ServerOpen>(leaseOpens);
                }
            }
        }
