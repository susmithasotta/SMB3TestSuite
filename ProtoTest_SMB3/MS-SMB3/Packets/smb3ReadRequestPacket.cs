...
// All rights reserved
// 
// Module Name: smb3ReadRequestPacket
// Description: smb3ReadRequestPacket defination.
//-------------------------------------------------------------------------
...
{
    /// <summary>
    /// The smb3 READ Request packet is sent by the client to request a read operation 
    /// on the file that is specified by the FileId
    /// </summary>
    public class smb3ReadRequestPacket : smb3StandardPacket<READ_Request>
    {
        /// <summary>
