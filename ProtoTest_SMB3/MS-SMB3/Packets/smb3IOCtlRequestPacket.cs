...
// All rights reserved
// 
// Module Name: smb3IOCtlRequestPacket
// Description: smb3IOCtlRequestPacket defination.
//-------------------------------------------------------------------------
...
{
    /// <summary>
    /// The smb3 IOCTL Request packet is sent by a client to issue an implementation-specific file 
    /// system control or device control (FSCTL/IOCTL) command across the network.
    /// </summary>
    public class smb3IOCtlRequestPacket : smb3StandardPacket<IOCTL_Request>
    {
        /// <summary>
