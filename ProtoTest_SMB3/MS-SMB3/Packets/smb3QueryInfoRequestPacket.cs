...
// All rights reserved
// 
// Module Name: smb3QueryInfoRequestPacket
// Description: smb3QueryInfoRequestPacket defination.
//-------------------------------------------------------------------------
...
{
    /// <summary>
    /// The smb3 QUERY_INFO Request (section 2.2.37) packet is sent by 
    /// a client to request information on a file, named pipe, or underlying volume
    /// </summary>
    public class smb3QueryInfoRequestPacket : smb3StandardPacket<QUERY_INFO_Request>, IHasInterrelatedFields
    {
        /// <summary>
        ...
        {
            PayLoad.InputBufferLength = (uint)PayLoad.Buffer.Length;
        }
        ...
        /// Constructor
        /// </summary>
        public smb3QueryInfoRequestPacket()
        {
            hasFileId = true;
        }
