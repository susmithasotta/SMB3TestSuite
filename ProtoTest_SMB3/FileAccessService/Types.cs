...
//
// Description: The message types used by FileAccessService
// ------------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk.FileAccessService
{
    ...
    /// <summary>
    /// the struct of MessageId and its statuses: consumed or not.
    /// </summary>
    public class MessageIdStatus
    {
        ...
        /// <summary>
        /// wether the messageId is used in request packet or not.
        /// </summary>
        ...
        /// <param name="isComsumed">true: the messageId hes been used in request packet.</param>
    ...
    public enum FsFileAttribute
    {
        ...
        /// used to to clear all other flags by specifying it with no other flags set.
        /// </summary>
    ...
    /// <summary>
    /// This can be used in desireAccess parameter of FileServiceBaseTransport.Connect()
    /// </summary>
    ...
    public enum FsCtlCode : uint
    {
        ...
        /// <summary>
        /// The FSCTL_QUERY_NETWORK_INTERFACE_INFO request requests the network interface info on the server         
        /// </summary>
    ...
    public struct RapRequestParam
    {
        ...
        /// <summary>
        /// This field conbine the following fields, because each of their length is unknown:<para/>
