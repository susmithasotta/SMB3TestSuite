...
namespace ProtoTest_SMB369124
{
    ...
    public class TDI69094
    {
        ...
        [TestMethod]
        public void SMB3_GeneralTest69094()
        {
            ...
            ////}
            smb3WriteRequestPacket requestWrite = smb3ClientStack.CreateWriteRequest((ulong)0, fileID, 0, buffer);
            ...
            smb3ReadRequestPacket read = smb3ClientStack.CreateReadRequest(1048577, 0, fileID, 0);
