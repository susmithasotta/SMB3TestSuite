...
namespace Microsoft.Protocols.TestTools.StackSdk
{
    ...
    /// in memory.
    /// 
    /// 3. create internal, private type of object in a assembly. 
    /// 
    ...
    public static class ObjectUtility
    {
        ...
        /// <summary>
        /// Clones an object. It copies all fields in the object along the class hierachy. 
        ...
        /// the class hierachy. If the field is by reference, e.g., a class instance, or array, it will do a recursive 
        ...
        /// <param name="instance1">The first instance.</param>
        /// <param name="instance2">The second instance.</param>
        /// <returns>True if all fields are euqal, false otherwise.</returns>
        ...
        private static Type LoadTypeFromAssembly(string assemblyName, string typeName)
        {
            ...
            throw new StackException(string.Format("Type {0} not found.", typeName));
        }
        ...
        private static MethodInfo FindMethod(Type type, string methodName, Type[] argTypes, bool isStatic)
        {
            ...
            throw new StackException(string.Format("Method {0} is not found.", methodName));
        }
        ...
        private static FieldInfo FindField(Type type, string fieldName)
        {
            ...
            throw new StackException(string.Format("Field {0} is not found.", fieldName));
        }
        ...
        private static PropertyInfo FindProperty(Type type, string propertyName)
        {
            ...
            throw new StackException(string.Format("Property {0} is not found.", propertyName));
        }
