...
namespace Microsoft.Protocols.TestTools.StackSdk
{
    ...
    public class SutControlProxy
    {
        ...
        /// configured in address attribute of endpoint element in
        /// SUT sontrol service's App.config file.
        /// </summary>
        ...
        public SutControlProxy(string sutAddress, uint port)
        {
            ...
            string sutControlServiceAddress = string.Format(ServiceAddressFormat, sutAddress, port);
        ...
        ///        {
        ///            // TODO: replace message with read from resource manager.
        ...
        {
            // TODO: no instruction on how to set the second parameter configId.
            // bug 20288 (Windows Servicing and Diagnostic Toolkit) has been filed for this issue.
        ...
        /// </summary>
        /// <param name="message">message to be loged, can be "xxx {0} {1} xxx" format.</param>
        /// <param name="args">arguments formatted into message.</param>
        private void Debug(string message, params object[] args)
        {
            // TODO: currently we have no usable stack Logging.
