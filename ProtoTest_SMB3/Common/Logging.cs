...
namespace Microsoft.Protocols.TestTools.StackSdk.Proxy
{
    ...
    public class StackSdkConfigurationData
    {
        ...
        public StackSdkConfigurationData(string xmlFileName)
        {
            ...
            {
                this.milliSecondsToGetLog = Convert.ToInt32(milliSecondsToGetLogNode.InnerText);
            }
        ...
        private void ReadUDPLogConfig()
        {
            ...
            if (udp != null)
            {
                ...
                foreach (System.Xml.XmlNode config in configs)
                {
                    ...
                    udpLogConfig.RemoteUdpPort = Convert.ToInt32(remoteUDPPort.Value);
...
namespace Microsoft.Protocols.TestTools.StackSdk
{
    ...
    public class LogConfig
    {
        ...
        public LogConfig(string fileName, string configId)
        {
            ...
            if (config == null)
            {
                throw new StackException(string.Format("the config can not be found, id={0}", configId));
            }
    ...
    internal abstract class LogConfigBase : IDisposable
    {
        ...
        /// <summary>
        /// create distination with special type
        /// </summary>
    ...
    public class Logger : IDisposable
    {
        ...
        /// <summary>
        /// The module who generate the log information
        /// </summary>
        public string Module
        {
            get
    ...
    public class LogManagement : IDisposable
    {
        ...
        /// <summary>
        /// The log thread which is used to capture log and write it the the 
        /// log destination.
        /// </summary>
    ...
    /// <summary>
    /// the log thread, to write log to distinations.
    /// </summary>
    public class LogThread : IDisposable
    {
        ...
        /// <summary>
        /// a event indicate whether this thread should be terminated
        /// </summary>
    ...
    /// <summary>
    /// interface for all log distination.
            ...
            lock (this.fileList)
            {
                ...
                if (config != null)
                {
                    ...
                    sw.WriteLine("<LogEntry kind=\"{0}\" timeStamp=\"{1}\" module=\"{2}\" category=\"{3}\">",
                        logMessage.LogLevel,
                        string.Format("{0}.{1}Z", logMessage.Date.ToString("s"), logMessage.Date.Millisecond),
