...
// All rights reserved
// 
// Module Name: EndpointManager
// Description: Manage endpoints. Two protocol will use different endpoint 
//              format, so supply a base class to manage the two types of 
//              endpoints.
//-------------------------------------------------------------------------
...
namespace Microsoft.Protocols.TestTools.StackSdk
{
        ...
        where T2 : class
    {
        ...
        /// </summary>
        /// <param name="currentProtocolEndpoint">The endpoint used by current protcol</param>
